...
public class PausedStatusTool implements Runnable {

    private final RoboticsAPIApplication app;
    private final RobotDataTool robotData;
    ...
    public PausedStatusTool(int port, RoboticsAPIApplication app, RobotDataTool robotData) {
        this.app = app;
