...
public class ReceiveToolCart implements Runnable {
    ...
    // Constructor method
    public ReceiveToolCart(RobotDataTool robotData, LBR robot, int receivePort, RoboticsAPIApplication app) throws Exception {
